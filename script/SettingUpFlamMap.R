...
## Fetch spatial data to inform artificial landscapes with real data  
  # EPA ecoregions for the Great Basin
  ...
  # MTBS wildfire perimeters for the Great Basin ecoregions
  ...
  # Get elevation data
    rgbif::elevation(latitude = 41.194343, 
                     ...
                     username = 'devanmcg')
##
## Develop hypothetical landscapes for FlamMap
##
  scale_factor = 0.33
  lcp_bbox <- 
    tibble(
