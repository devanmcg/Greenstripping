...
\Title{Fuel Properties Of Effective Greenstrips In Simulated Cheatgrass Fires }

% MDPI internal command: Title for citation in the left column
\TitleCitation{Fuel Properties Of Effective Greenstrips In Simulated Cheatgrass Fires}

\newcommand{\orcidauthorA}{0000-0002-3763-7641} 
\newcommand{\orcidauthorB}{0000-0000-0000-000X}

\Author{Devan Allen McGranahan $^{1,}$\orcidA{}*, Carissa L. Wonkka $^{2,}$\orcidB{}}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Devan Allen McGranahan, Carissa L. Wonkka}

% MDPI internal command: Authors, for citation in the left column
\AuthorCitation{McGranahan, D.A.; Wonkka, C.L.}
...
$^{2}$ \quad USDA Agricultural Research Service, Northern Plains Agricultural Research Laboratory, Sidney, MT 59270 USA; Carissa.Wonkka@usda.gov}
...
% Keywords
\keyword{\emph{Bromus tectorum}; Fuelbed ecology; Invasive species fire ecology and management; Landscape ecology of fire; Spatial fire behavior modelling; U.S. Great Basin} 
